package main.java.org.example.draw.src.main.java.ua.opnu.view;

import main.java.org.example.draw.src.main.java.ua.opnu.model.DrawShape;
...
public class DrawFrame extends JFrame {
    ...
    private JPanel setButtonPanel() {
        ...
        // Еліпс
        BigTextButton elps = new BigTextButton("Ellipse.");
        elps.addActionListener( e -> {
            surface.setShapeType(DrawShape.SHAPE_ELLIPSE);
        });
        buttonPanel.add(elps);
